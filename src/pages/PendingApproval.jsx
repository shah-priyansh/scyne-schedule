    ...
    return (
        <div className={'grid grid-cols-1'}>
            <div className={'col-span-1'}>
                <div className={'p-3 sm:p-3 md:p-5 page-top-head border-b border-light'}>
                    <div className={'flex flex-col gap-3'}>
                        <div className={'text-base sm:text-base md:text-xl font-bold'}>Pending Approval</div>
            ...
            <div className={'p-3 sm:p-3 md:p-5 bg-gray-50'}>
                <div className={'border-1 border-light bg-white rounded-xl overflow-hidden'}>
                    <div className={'bg-[#F0F0F0] p-4 flex justify-between items-center gap-3'}>
                        <div className={'flex flex-wrap gap-3 items-center'}>
                            <div>
                                <small
                                    ...
                                    Period:
                                    Weekly</small>
                                <div className={'text-base sm:text-base md:text-xl font-bold'}>01 Sep – 07 Sep 2025
                                    2025
                                </div>
                        ...
                        <div>
                            <Dialog>
                                ...
                                <DialogContent
                                    ...
                                    <DialogDescription className={"max-h-[80vh] overflow-y-auto rounded-xl"}>
                                        <div className={''}>
                                            <div className={'grid gap-4 p-5'}>
                                                ...
                                                <div className="relative overflow-x-auto">
                                                    <div className={'border-1 border-light rounded-xl overflow-hidden'}>
                                                        <Table>
                                                            <TableHeader>
                                                                <TableRow
                    ...
                    <div className={'p-4 flex justify-between border-t border-light'}>
                        <div className={'text-sm sm:text-sm md:text-base font-semibold'}>
                            Example Project
                        </div>
                        <div className={'flex gap-1 font-medium items-center'}>
                            <div>
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M7 3.25V7.25H10M13 7.25C13 8.03793 12.8448 8.81815 12.5433 9.5461C12.2417 10.2741 11.7998 10.9355 11.2426 11.4926C10.6855 12.0498 10.0241 12.4917 9.2961 12.7933C8.56815 13.0948 7.78793 13.25 7 13.25C6.21207 13.25 5.43185 13.0948 4.7039 12.7933C3.97595 12.4917 3.31451 12.0498 2.75736 11.4926C2.20021 10.9355 1.75825 10.2741 1.45672 9.5461C1.15519 8.81815 1 8.03793 1 7.25C1 5.6587 1.63214 4.13258 2.75736 3.00736C3.88258 1.88214 5.4087 1.25 7 1.25C8.5913 1.25 10.1174 1.88214 11.2426 3.00736C12.3679 4.13258 13 5.6587 13 7.25Z"
                                        stroke="#3D3D3D" stroke-width="1.2" stroke-linecap="round"
                    ...
                    <div className={'h-[50vh] flex items-center justify-center'}>
                        <div className={'flex justify-center flex-col items-center gap-0'}>
                            ...
                            <div className={'light-600 text-sm'}>
                                All your submitted timesheets have already been reviewed.
                            </div>
                        </div>
                    </div>
                </div>
